...
namespace BiebCWebsite.Controllers
{
    public class AdminModelsController : Controller
    {
        ...
        public AdminModelsController(BiebCWebsiteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.AdminModel != null ? 
                          ...
                          Problem("Entity set 'BiebCWebsiteContext.AdminModel'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,lastName,Email,Phone,PostalCode")] AdminModel adminModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,lastName,Email,Phone,PostalCode")] AdminModel adminModel)
        {
            if (id != adminModel.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BiebCWebsiteContext.AdminModel'  is null.");
            }
            var adminModel = await _context.AdminModel.FindAsync(id);
            if (adminModel != null)
            {
