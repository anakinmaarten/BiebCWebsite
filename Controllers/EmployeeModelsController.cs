...
namespace BiebCWebsite.Controllers
{
    public class EmployeeModelsController : Controller
    {
        ...
        public EmployeeModelsController(BiebCWebsiteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.EmployeeModel != null ? 
                          ...
                          Problem("Entity set 'BiebCWebsiteContext.EmployeeModel'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,lastName,Email,Phone,PostalCode")] EmployeeModel employeeModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,lastName,Email,Phone,PostalCode")] EmployeeModel employeeModel)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BiebCWebsiteContext.EmployeeModel'  is null.");
            }
            var employeeModel = await _context.EmployeeModel.FindAsync(id);
            if (employeeModel != null)
            {
